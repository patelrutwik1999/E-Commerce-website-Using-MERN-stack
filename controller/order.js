...
sgMail.setApiKey('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');
...
exports.create = (req, res) => {
    ...
    order.save((error, data) => {
        ...
        // order.amount
        const emailData = {
            to: 'rutwikpatel290499@gmail.com', // admin
            from: 'rutwikpatel1999@gmail.com',
